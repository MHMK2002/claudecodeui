...
export const CollapsibleSection: React.FC<CollapsibleSectionProps> = ({
  ...
  return (
    <Collapsible defaultOpen={open} className={cn('group/section', className)}>
      ...
      {onTitleClick ? (
        <div className="flex cursor-default select-none flex-wrap items-center gap-x-1.5 gap-y-1 py-0.5 text-xs group-data-[state=open]/section:sticky group-data-[state=open]/section:top-0 group-data-[state=open]/section:z-10 group-data-[state=open]/section:-mx-1 group-data-[state=open]/section:bg-background group-data-[state=open]/section:px-1">
