...
export default function FileTreeNode({
  ...
  const rowClassName = cn(
    viewMode === 'detailed'
      ? 'group grid min-h-11 grid-cols-12 cursor-pointer items-center gap-2 rounded-sm py-1 pr-2 transition-colors duration-100 hover:bg-accent/60'
      : viewMode === 'compact'
      ? 'group flex min-h-11 cursor-pointer items-center justify-between rounded-sm py-1 pr-2 transition-colors duration-100 hover:bg-accent/60'
      : 'group flex min-h-11 cursor-pointer items-center gap-1.5 rounded-sm py-1 pr-2 transition-colors duration-100 hover:bg-accent/60',
