...
import { Check, ChevronDown, ChevronRight, Copy, Edit2, Loader2, MoreHorizontal, Trash2, X } from 'lucide-react';
      ...
      <div className="hidden md:flex md:items-center md:gap-1">
        ...
        <a
          ...
          className={cn(
            ...
            // flex-1: the agent chevron sits beside this anchor as a sibling.
            // pr-11: reserve room for the absolutely-positioned options button.
            'h-auto min-w-0 flex-1 justify-start rounded-md border bg-card p-2 pr-11 text-left font-normal transition-all duration-150',
