...
export function createTaskmasterRouter(dependencies: TaskmasterRouterDependencies): express.Router {
     ...
     */
    // Task creation must go through the Task-intake flow so a clarified proposal
    // is explicitly approved first; this legacy direct-create path stays closed.
     ...
     */
    // Same intake guard as /add-task: a PRD parse would bulk-create tasks.
